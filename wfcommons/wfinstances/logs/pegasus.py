...
class PegasusLogsParser(LogsParser):
    ...
    def _parse_braindump(self):
        ...
        # sanity checks
        if not wms_version:
            raise ValueError(f"Unable to determine Pegasus version. Likely old logs generated by Pegasus 5.x. No longer supported")
        ...
        if wms_version_number < 500:
            raise ValueError(
                f"Unable to determine Pegasus version. Likely old logs generated by Pegasus 5.x. No longer supported")
